...
#	version = testing[i]
	...
	for group in 2:8
		...
		writedlm(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/split_only/", version, "bigrootstateprobs", group, "_inf_7000.csv"), headings, ',')
		...
		for i in 1:length(directorynames)
			...
			CSV.write("branchbottoms_inf_7000.csv", testbottom2)
			CSV.write("branchtops_inf_7000.csv", testtop2)
			CSV.write("inferredtable_inf_7000.csv", trdf[R_node_order,:])
			
			writedlm("rootstate_probs_inf_7000.txt", rootstateprobs)
			...
			CSV.write(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/split_only/", version ,"bigrootstateprobs", group ,"_inf_7000.csv"), Tables.table(vert2), append=true)

			writedlm("total_lnl_inf_7000.txt", Julia_total_lnLs1)
			writedlm("rootstates_lnl_inf_7000.txt", rootstates_lnL)
		end
	end
#end
