...
#	version = testing[i]
	...
	for group in 2:8
		...
		writedlm(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version, "bigrootstateprobs", group, "_ss_7000.csv"), headings, ',')
		...
		for i in 1:length(directorynames)
			...
			CSV.write("branchbottoms_ss_7000.csv", testbottom2)
			CSV.write("branchtops_ss_7000.csv", testtop2)
			CSV.write("inferredtable_ss_7000.csv", trdf[R_node_order,:])
			
			writedlm("rootstate_probs_ss_7000.txt", rootstateprobs)
			...
			CSV.write(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version ,"bigrootstateprobs", group ,"_ss_7000.csv"), Tables.table(vert2), append=true)

			writedlm("total_lnl_ss_7000.txt", Julia_total_lnLs1)
			writedlm("rootstates_lnl_ss_7000.txt", rootstates_lnL)
		end
	end
#end
