...
d_rate = 0.1 # range expansion
e_rate = 0.1 # range contraction
...
#396
    for (i in 1:600){
        ...
        wd = paste0("/Users/wbla447/Desktop/School/WallisCastor/September2023/split_only/V", V ,"/ss", ss, "/")
        setwd(wd)
        dir.create(paste0("sim_", sprintf("%03s", i)))

        wd = paste0("/Users/wbla447/Desktop/School/WallisCastor/September2023/split_only/V", V ,"/ss", ss, "/sim_", sprintf("%03s", i),"/")
        setwd(wd)
