...
#	version = testing[i]
	...
	for group in 2:5
		...
		wd = string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version, "ss", group)
		cd(wd)
		...
		writedlm(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version, "bigrootstateprobs", group, "_spread_7000.csv"), headings, ',')
		...
		# Only needed for versions of the simulation that didn't work? I believe these were when speciation or extinction was extra high?
		# Only dont in early versions, before the big plot versions
		...
		# writedlm("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/8StateFiles/distances.txt", distmats)
		...
		# 	cd(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/8SplitSpreadFiles/GoodSims/GoodSims", group, "_095/", directorynames[i]))
		# 	trfn = "newtree"
		...
		# 	cd(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/8SplitSpreadFiles/GoodSims/GoodSims", group, "_095/"))
		...
		for i in 1:length(directorynames)
			cd(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version ,"ss", group, "/", directorynames[i]))
			...
			CSV.write("branchbottoms_spread_7000.csv", testbottom2)
			CSV.write("branchtops_spread_7000.csv", testtop2)
			CSV.write("inferredtable_spread_7000.csv", trdf[R_node_order,:])
			
			writedlm("rootstate_probs_spread_7000.txt", rootstateprobs)
			...
			CSV.write(string("/Users/wbla447/Library/CloudStorage/OneDrive-TheUniversityofAuckland/School/WallisCastor/September2023/splitspread/", version ,"bigrootstateprobs", group ,"_spread_7000.csv"), Tables.table(vert2), append=true)

			writedlm("total_lnl_spread_7000.txt", Julia_total_lnLs1)
			writedlm("rootstates_lnl_spread_7000.txt", rootstates_lnL)
		end
	end
#end
